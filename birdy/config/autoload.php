...
function autoload($class) {
    ...
    if (file_exists(BIRDY_BASE.DS.'birdy'.DS.'classes'.DS. $class . ".php")) {
        require BIRDY_BASE.DS.'birdy'.DS.'classes'.DS. $class . ".php";
    } else {
        exit ('The file ' . $class . '.php is missing in the classes folder.');
    }
}
