...
Class birdyConfig {
	...
	static $db_name = 'klipsam_db';
	static $db_user = 'klipsam_dbuser';
	static $db_password = '2666branka.babic';
	static $db_port = null;
	static $db_encoding = null;
	
	static $site_email = 'info@klipsam.com';
	
	static $template = "classic";
	static $allow_comments = 1;
	static $antispam_method = '';
	static $akismetAPIkey = '';
	static $commentsMethod = '';
	static $disqus_shortname = 'chrismichaelides';
	
	static $syntaxHighlighterArticle = 1;
	static $syntaxHighlighterComments = 1;
	static $syntaxHighlighterTheme = 'Eclipse';
	// available are: Default, Django, Eclipse, Emacs, FadeToGrey, MDUltra, Midnight, RDark
	
	static $googleHighlighterArticle = 0;
	static $googleHighlighterComments = 0;
	static $googleHighlighterSkin = 'desert';
	
	static $codesToHighlight = array( 'php', 'css', 'js', 'sql' );
	
	static $error_reporting = -1;
	
	static $user_access = 1;
	static $login_page = '/login';
	static $logout_page = '/logout';
	static $login_redirection = '/';
	static $logout_redirection = '/';
	static $profile_url = '/klipper';
	static $use_real_name = 1;
	
	static $use_lightbox = 1;
	
	// the api key of your application. it is needed to retrieve people in circles of google+ user
	static $googleAPIkey = 'AIzaSyB84DZKonqRx__86K2U0f8hbpvKcDufb9E';
	
	public static function setDEFINES() {
		DEFINE("_MAX_REPORTS",1);
		...
		*/
		...
		ini_set("display_errors", birdyConfig::$error_reporting);
		...
		*/
		...
		define('AVATAR_DEFAULT_IMAGE', 'default.png');
		...
		*/
		...
		define('COOKIE_DOMAIN', '.'.str_replace(array("http://www.","https://www","http:","https:","/"),"",BIRDY_URL));
		...
		*/
		define("EMAIL_PASSWORD_RESET_URL", URL . "login/verify/passwordreset");
		define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "no-reply@klipsam.com");
		define("EMAIL_PASSWORD_RESET_FROM_NAME", "Klipsam");
		define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset for Klipsam");
		define("EMAIL_PASSWORD_RESET_CONTENT", "Dear Klipper,\n
		You have recently requested to reset your password.\n
		In case it wasn't you who requested the password reset, just ignore this message.\n\n
		Please click on this link to reset your password:\n\n");

		define("EMAIL_VERIFICATION_URL", URL . "login/verify/accountactivation");
		define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@klipsam.com");
		define("EMAIL_VERIFICATION_FROM_NAME", "Klipsam");
		define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Klipsam");
		define("EMAIL_VERIFICATION_CONTENT", "Welcome to Klipsam!\n\n
		In Kipsam you can klip everything you like. Images, videos, your favorite articles, or even your personal notes!\n\n
		...
		*/
		define("FEEDBACK_UNKNOWN_ERROR", "An error occurred");
		...
		define("FEEDBACK_LOGIN_FAILED", "Login failed. Please try again.");
		define("FEEDBACK_USERNAME_FIELD_EMPTY", "Please enter your user credentials.");
		define("FEEDBACK_PASSWORD_FIELD_EMPTY", "Please enter a password.");
		define("FEEDBACK_EMAIL_FIELD_EMPTY", "Please enter an email address.");
		define("FEEDBACK_EMAIL_AND_PASSWORD_FIELDS_EMPTY", "Please enter an email address.");
		...
		define("FEEDBACK_PASSWORD_REPEAT_WRONG", "The confirmation of your password has failed. Please try again.");
		define("FEEDBACK_PASSWORD_TOO_SHORT", "Password is too short! Please give a password with a minimum length of 6 characters.");
		...
		define("FEEDBACK_AVATAR_UPLOAD_SUCCESSFUL", "Profile picture uploaded successfully");
		define("FEEDBACK_AVATAR_UPLOAD_WRONG_TYPE", "Only JPEG and PNG files are supported");
		define("FEEDBACK_AVATAR_UPLOAD_TOO_SMALL", "Profile picture width/height is too small. Needs to be 200x200 pixels minimum.");
		define("FEEDBACK_AVATAR_UPLOAD_TOO_BIG", "Profile picture file is too big. 5 Megabyte is the maximum.");
		...
		define("FEEDBACK_PASSWORD_RESET_MAIL_SENDING_SUCCESSFUL", "A password reset mail has been sent to your email address. Please follow the link in the email to reset your password.");
		...
		define("FEEDBACK_COOKIE_INVALID", "");
		define("FEEDBACK_COOKIE_LOGIN_SUCCESSFUL", "Welcome back %user!");//You were successfully logged in via the remember-me-cookie.");
